...
module.exports = {
    ...
    theme: {
        ...
        fontSize: {
            xxl: ['104px', { lineHeight: '112px' }],
            'xxl-m': ['48px', { lineHeight: '64px' }],
            ...
            'xl-1': ['88px', { lineHeight: '96px' }],
            'xl-1-m': ['44px', { lineHeight: '56px' }],
            'h-1': ['72px', { lineHeight: '80px', letterSpacing: '-0.05em' }],
            'h-2': ['64px', { lineHeight: '72px', letterSpacing: '-0.05em' }],
            'h-3': ['56px', { lineHeight: '64px', letterSpacing: '-0.05em' }],
            'h-4': ['48px', { lineHeight: '56px', letterSpacing: '-0.05em' }],
            'h-5': ['40px', { lineHeight: '48px', letterSpacing: '-0.05em' }],
            'h-6': ['32px', { lineHeight: '40px', letterSpacing: '-0.025em' }],
            'h-1-m': ['40px', { lineHeight: '56px', letterSpacing: '-0.05em' }],
            'h-2-m': ['36px', { lineHeight: '44px', letterSpacing: '-0.05em' }],
            'h-3-m': ['32px', { lineHeight: '40px', letterSpacing: '-0.05em' }],
            'h-4-m': [
                '28px',
                { lineHeight: '36px', letterSpacing: '-0.025em' },
            ],
            'h-5-m': [
                '24px',
            ...
            'sh-7': ['22px', { lineHeight: '32px', letterSpacing: '-0.025em' }],
            'sh-8': ['18px', { lineHeight: '24px', letterSpacing: '-0.025em' }],
            'sh-9': ['16px', { lineHeight: '24px', letterSpacing: '-0.025em' }],
            'cta-1': [
                '18px',
                { lineHeight: '32px', letterSpacing: '-0.025em' },
            ],
            ...
            'cta-1-m': ['18px', { lineHeight: '24px' }],
            'cta-2-m': ['16px', { lineHeight: '24px' }],
            'body-1': [
                '22px',
                { lineHeight: '32px', letterSpacing: '-0.025em' },
            ],
            ...
            'body-5': ['12px', { lineHeight: '20px' }],
            'body-6': ['11px', { lineHeight: '15px' }],
            'body-1-m': [
                '20px',
                { lineHeight: '32px', letterSpacing: '-0.025em' },
            ],
            'body-2-m': ['18px', { lineHeight: '28px' }],
            'body-3-m': ['16px', { lineHeight: '24px' }],
            'body-4-m': ['14px', { lineHeight: '22px' }],
            'body-5-m': ['12px', { lineHeight: '20px' }],
            'body-6-m': ['10px', { lineHeight: '16px' }],
