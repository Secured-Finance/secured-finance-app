    ...
    <div className='inline-grid w-full grid-cols-1 gap-4 bg-[#010316] p-10'>
        <div className='flex-col items-start justify-start'>
            <div className='flex flex-col items-start justify-start space-y-4'>
                <p className='text-h-5-m text-neutral-50'>Neutral</p>
        ...
        <div className='inline-flex flex-col items-start justify-start space-y-4'>
            <p className='text-h-5-m text-neutral-50'>Primary</p>
            <div className='inline-flex items-center justify-start space-x-6'>
        ...
        <div className='inline-flex flex-col items-start justify-start space-y-4'>
            <p className='text-h-5-m text-neutral-50'>Secondary</p>
            <div className='inline-flex items-center justify-start space-x-6'>
        ...
        <div className='inline-flex flex-col items-start justify-start space-y-4'>
            <p className='text-h-5-m text-neutral-50'>Tertiary</p>
            <div className='inline-flex items-center justify-start space-x-6'>
        ...
        <div className='inline-flex flex-col items-start justify-start space-y-4'>
            <p className='text-h-5-m text-neutral-50'>Success</p>
            <div className='inline-flex items-center justify-start space-x-6'>
        ...
        <div className='inline-flex flex-col items-start justify-start space-y-4'>
            <p className='text-h-5-m text-neutral-50'>Warning</p>
            <div className='inline-flex items-center justify-start space-x-6'>
                ...
                <div className='h-10 w-32 rounded-lg bg-warning-900' />
            </div>
        </div>
        <div className='inline-flex flex-col items-start justify-start space-y-4'>
            <p className='text-h-5-m text-neutral-50'>Error</p>
            <div className='inline-flex items-center justify-start space-x-6'>
