...
export const NewOrderBookWidget = ({
    ...
    return (
        <div className='flex h-full w-full flex-col justify-start gap-y-1 overflow-visible border-white-10 laptop:flex-col-reverse laptop:gap-y-0 laptop:rounded-b-xl laptop:border laptop:bg-cardBackground/60 laptop:shadow-tab'>
