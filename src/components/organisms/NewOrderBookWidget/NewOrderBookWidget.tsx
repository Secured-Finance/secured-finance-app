...
const OrderBookCell = ({
    ...
    <span
        className={clsx(
            'z-[1] font-tertiary text-[11px] font-normal leading-[14px] laptop:text-xs laptop:leading-4',
            {
...
export const NewOrderBookWidget = ({
    ...
    rowsToRenderMobile?: 10 | 12 | 14 | 16 | 18;
}) => {
    ...
    return (
        <div className='flex h-full w-full flex-col justify-start gap-y-1 overflow-hidden bg-neutral-900 shadow-tab laptop:flex-col-reverse laptop:gap-y-0 laptop:rounded-b-xl'>
            <div className='table h-full'>
                {orderbook.isLoading ? (
                    ...
                    <div className='flex flex-col laptop:gap-y-0'>
                        <div
                            className={clsx('flex', {
                        ...
                        <div className='flex h-5 flex-row items-center justify-between py-1 laptop:h-fit laptop:bg-black-20 laptop:px-4 laptop:py-3'>
                            <span
                                className='font-secondary text-base font-semibold leading-6 text-neutral-50'
                                data-testid='current-market-price'
                            >
                                <p>{formatLoanValue(marketPrice, 'price')}</p>
                            </span>
                            <span className='font-secondary text-xs font-semibold leading-5 text-[#D4FCFF] laptop:text-sm laptop:leading-[22px]'>
            ...
            <div className='flex flex-col laptop:flex-col-reverse'>
                <div className='flex flex-row items-center justify-between gap-1 border-neutral-700 laptop:flex-row-reverse laptop:border-b laptop:px-3 laptop:py-2'>
                    <div className='flex flex-1 rounded border-0.5 border-neutral-500 bg-neutral-700 px-2 py-1 font-secondary text-2xs leading-4 text-neutral-400 laptop:w-fit laptop:flex-none laptop:border-none laptop:bg-neutral-600 laptop:py-[2px] laptop:text-xs laptop:leading-5'>
