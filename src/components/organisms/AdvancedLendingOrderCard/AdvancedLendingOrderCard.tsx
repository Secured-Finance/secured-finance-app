...
export function AdvancedLendingOrderCard({
    ...
    return (
        <div className='flex h-full flex-col gap-4 rounded-b-xl border-white-10 pb-3 laptop:gap-0 laptop:border laptop:bg-cardBackground laptop:bg-opacity-60 laptop:pb-7'>
            <div>
                <RadioGroupSelector
                ...
                <div className='grid w-full grid-cols-12 gap-5 border-y border-neutral-600 px-4 py-4 laptop:gap-0 laptop:border-y-0 laptop:pb-4 laptop:pt-5'>
