...
import { Position, useLastPrices } from 'src/hooks';
import {
    resetUnitPrice,
    setCurrency,
    setMaturity,
            ...
            <>
                {data.map(
                    (
                        ...
                        const buttonItems = getTableActionMenu(
                            Number(maturity),
                            absAmount,
                            ccy as CurrencySymbol,
                            side
                                    ...
                                    <div className='flex flex-col gap-2.5'>
                                        {buttonItems.map((item, i) => (
                                            <button
                                                ...
                                                className='rounded-lg border border-secondary7 px-3 py-1.5 text-xs font-semibold leading-4 text-secondary7 disabled:border-neutral-600 disabled:bg-neutral-600 disabled:text-neutral-400'
