export const ThreeColumnsWithTopBar = ({
    ...
    return (
        <div className='grid h-fit grid-cols-1 place-items-stretch gap-x-3 tablet:grid-cols-2 tablet:gap-y-4 laptop:grid-cols-4'>
            ...
            <div className='tablet:col-span-2'>{children[2]}</div>
        </div>
    );
};
