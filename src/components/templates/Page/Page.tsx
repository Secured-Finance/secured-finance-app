...
export const Page = ({
    ...
    return (
        <div
            className='relative mx-auto flex flex-col gap-2 pt-3 tablet:min-w-[728px] laptop:min-w-[970px] laptop:gap-4 laptop:px-6 laptop:pt-6 desktop:min-w-[1120px] desktop:max-w-[1920px]'
            data-testid={name}
        >
            {alertComponent && (
