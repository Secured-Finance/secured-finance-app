...
import { HDWallet, useNewFilWalletProvider } from '../../../services/filecoin'
	...
	return (
		<Modal>
			...
			<ModalContent paddingBottom={'0'} paddingTop={'0'}>
                <StyledModalSubtitle>Your mnemonic phrase is the access key to all your cryptocurrencies. Keep your mnemonic on a secure environment. Without the phrase you will not be able to recover your money.</StyledModalSubtitle>
