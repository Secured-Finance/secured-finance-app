            ...
            {() => (
                <>
                    <Popover.Button
                        ...
                        className='flex items-center rounded-[6px] bg-neutral-800 p-[7px] ring-1 ring-neutral-500 focus:outline-none tablet:rounded-xl tablet:px-[0.875rem] tablet:py-[0.8125rem] tablet:ring-[1.5px]'
                    >
