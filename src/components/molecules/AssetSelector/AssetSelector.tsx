    ...
    return (
        <div>
            <div className='w-72 flex-col items-start justify-start space-y-2'>
                ...
                <div className='flex h-14 w-72 flex-row items-center justify-between space-x-2 rounded-lg bg-black-20 py-2 pl-2 pr-4 focus:border-2 focus:border-horizonBlue'>
                    <div>
                        <DropdownSelector
                            optionList={options}
                            onChange={setAsset}
