					...
					<StyledTableRow {...headerGroup.getHeaderGroupProps()}>
						{headerGroup.headers.map((column) => {
							return column.isHiddenHeader === false ? null : (
								<StyledTableHeaderText {...column.getHeaderProps(column.getSortByToggleProps())}>
									<StyledTableItemContainer>
										{column.render('Header')}
										<StyledSVGContainer>
											{column.isSorted ? column.isSortedDesc
												? <ArrowSVG width={'15'} height="6" rotate={0} fill="#3E6989" stroke="#3E6989"/>
												: <ArrowSVG width={'15'} height="6" rotate={180} fill="#3E6989" stroke="#3E6989"/>
											: <ArrowSVG width={'15'} height="6" rotate={0} fill="#3E6989" stroke="#3E6989"/>}					  
										</StyledSVGContainer>
									</StyledTableItemContainer>
