...
import { contractsAddresses, SUBTRACT_GAS_LIMIT } from './utils.js';
...
export class Contracts {
    constructor(provider, networkId, web3, options) {
        ...
        this.lendingController = new this.web3.eth.Contract(
            ...
            return {
                ...
                markets: ccyMarkets.markets.map(lendingMarket => {
                    return {
                        ...
                        lendingMarket: new this.web3.eth.Contract(
                            LendingMarketAbi
                        ),
    ...
    setProvider(provider, networkId) {
        ...
        setProvider(
            this.lendingController,
            contractsAddresses.lendingController
        );
