...
import { Transport, WagmiProvider, fallback, http } from 'wagmi';
...
export const wagmiConfig = defaultWagmiConfig({
    ...
    pollingInterval: networks.reduce((acc, chain) => {
        acc[chain.id] = chain.id.toString().startsWith('314') ? 12_000 : 4_000;
        return acc;
