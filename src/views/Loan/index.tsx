        ...
        <StyledInfoContainer>
            ...
            <StyledSubcontainer>
              ...
              <StyledItemContainer background={'none'}>
                ...
                <StyledRowContainer marginTop={'10px'}>
                  ...
                  <StyledItemText>{formatDate(loan.start)}</StyledItemText>
                </StyledRowContainer>
                <StyledRowContainer marginTop={'10px'}>
                  <StyledItemText>Maturity Date</StyledItemText>
                  <StyledItemText>{formatDate(loan.end)}</StyledItemText>
                </StyledRowContainer>
                <StyledRowContainer marginTop={'10px'}>
                ...
                <StyledRowContainer marginTop={'10px'}>
                  ...
                  <StyledItemText>{handleTotalRepay()}</StyledItemText>
                </StyledRowContainer>
              </StyledItemContainer>
            </StyledSubcontainer>
          ...
          <StyledColumn>
            <StyledSubcontainer>
              ...
              <StyledItemContainer marginBottom={'0px'} background={'none'}>
                <StyledRowContainer>
                  <StyledItemText fontSize={16} fontWeight={600}>
                    {ordinaryFormat(couponPayment.coupon) + ' FIL'}
                  </StyledItemText>
                ...
                <StyledRowContainer marginTop={'10px'}>
                  <StyledItemText fontSize={12} opacity={0.9} fontWeight={400}>
