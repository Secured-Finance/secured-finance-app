    ...
    return (
        <StyledSpreadContainer>
			<StyledSpreadInfoContainer>
				...
				<StyledSpreadItemText color={theme.colors.white} fontSize={theme.sizes.body} marginTop={4} fontWeight={500}>{percentFormat(spread)}</StyledSpreadItemText>
			</StyledSpreadInfoContainer>
			<StyledSpreadInfoContainer>
				<StyledSpreadItemText>Market Rate</StyledSpreadItemText>
				<StyledSpreadItemText color={theme.colors.green} fontSize={theme.sizes.body} textAlign={"right"} marginTop={4} fontWeight={500}>{percentFormat(rate)}</StyledSpreadItemText>
			</StyledSpreadInfoContainer>
        </StyledSpreadContainer>
    );
}
